...
public class SimulatedSolderingDriver : DemoSimulatedDriverBase
{

    [ResourceReference(ResourceRelationType.Driver, ResourceReferenceRole.Source)]
    public SolderingCell Cell { get; set; }
    ...
    {
        Received?.Invoke(this, new SolderingCompletedMessage { Result = result.Result });
    }
